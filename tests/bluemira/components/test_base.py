...
from bluemira.components.base import Component, GroupingComponent
...
class TestBaseClass:
    ...
    class MyReactorSystem(GroupingComponent):
        """
...
class TestDefineSystemClass:
    ...
    class DummyReactorSystem(GroupingComponent):
        """
    ...
    class DummySecondReactorSystem(GroupingComponent):
        """
