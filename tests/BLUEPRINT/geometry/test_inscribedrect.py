...
from BLUEPRINT.geometry.inscribedrect import inscribed_rect_in_poly, _rect
...
class TestInscribedRectangle:
    ...
    circle_xz_offset = circle_seg(0.6, h=(5, -5))
    ...
    def test_zero(self):
        assert inscribed_rect_in_poly(self.diamond, (0, 0)) == (0, 0)
