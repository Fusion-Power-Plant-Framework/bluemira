...
# to the poiloidal field (vacuum field) is kept the same in the region
...
#
# Result is 'psi_harmonic_ampltidues', a.k.a., the coeffcients necessary
...
# and the LCFS found using our approximation (dashsed blue line).
#
