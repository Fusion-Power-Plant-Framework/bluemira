...
"""
Time evolution of SSEN production and consumption power loads in EUDEMO
2017 baseline power plant (indirect HCPB-BoP concept) using the Power
Cycle module.
...
if __name__ == "__main__":
    ...
    ManagerKit.plot_detailed_phaseload(ftt_active_phaseload, "active")
    ...
    ManagerKit.plot_detailed_phaseload(ftt_reactive_phaseload, "reactive")
