...
params = {
    ...
    "rec_ext_out_leg": {"value": 2.5, "unit": "m"},
...
# %%
if CORE_RADIATION and SOL_RADIATION:
    config = {
...
elif CORE_RADIATION and not SOL_RADIATION:
    config = {
        "f_imp_core": {"H": 1e-1, "He": 1e-2, "Xe": 1.5e-4, "W": tungsten_fraction},
        "f_imp_sol": {"H": 0, "He": 0, "Ar": 0, "Xe": 0, "W": 0},
        "tau_core": np.inf,
        "tau_sol": 10,
    }
elif SOL_RADIATION and not CORE_RADIATION:
    config = {
        "f_imp_core": {"H": 0, "He": 0, "Xe": 0, "W": 0},
        "f_imp_sol": {"H": 0, "He": 0, "Ar": 0.0018, "Xe": 0, "W": 0},
        "tau_core": np.inf,
        "tau_sol": 10,
    }
