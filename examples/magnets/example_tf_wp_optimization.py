...
bluemira_print(
    f"before optimization: conductor dx_cable = {cable.dx}, aspect ratio = {cable.aspect_ratio}"
)
T_for_hts = T0
...
bluemira_print(
    f"after optimization: conductor dx_cable = {cable.dx}, aspect ratio = {cable.aspect_ratio}"
)

cable.set_aspect_ratio(2)
bluemira_print(
    f"Adjust aspect ratio: conductor dx_cable = {cable.dx}, aspect ratio = {cable.aspect_ratio}"
)
# %%
# case parameters
...
case.plot(show=True, homogenized=False)
# %% md
# ## Optimize
# %%
