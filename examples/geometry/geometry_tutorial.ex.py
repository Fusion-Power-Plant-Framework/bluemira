...
magnet_data = read_json(magnet_filename)
...
# Now we create the magnets from splines.
magnet_curves = []
for curve_dict in magnet_data:
    ...
    magnet_curves.append(magnet_curve)


show_cad(magnet_curves + [plasma_surface])
