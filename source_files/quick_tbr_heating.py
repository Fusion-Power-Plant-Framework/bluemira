...
def run_tbr_heating_calc(
    ...
    stochastic_vol_calc = runtime_variables[
        "stochastic_vol_calc"
    ]  # Boolean for performing stochastic volume calc
    plot_geometry = runtime_variables["plot_geometry"]  # Boolean for plotting geometry
    no_of_particles = runtime_variables[
        "no_of_particles"
    ]  # Number of particles in each of two batches
    ...
    fw_surf_cell_filter = openmc.CellFilter(
    ...
    if stochastic_vol_calc:
        ...
        cell_vol_calc = openmc.VolumeCalculation(
            fw_inb_surf_cells + [div_surf_cell] + fw_outb_surf_cells,
...
if __name__ == "__main__":
    ...
    runtime_variables = {
        ...
        "plot_geometry": True,
        "no_of_particles": 18000,
    }  # 18000 = 5 seconds,  1000000 = 259 seconds }

    reactor_power_MW = 1998.0

    blanket_type = "hcpb"

    material_variables = {"li_enrich_ao": 60.0}  # atomic fraction percentage of lithium
