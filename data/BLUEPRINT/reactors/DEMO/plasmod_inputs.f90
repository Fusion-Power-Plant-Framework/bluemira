    ...
    geom%R = 8.9264d0  ! major radius in m
    geom%bt = 5.834 !magnetic field
    geom%k = 1.7920000000000003d0 !edge elongation
    geom%d = 0.49950000000000006d0 !edge triangularity
    geom%k95 = 1.6d0 !edge elongation
    geom%d95 = 0.333d0 !edge triangularity
    geom%Ip =  18.65 !plasma current in MA : USED if equiltype=2, q95 is used if equiltype=1
