...
class ArbitraryCrossSectionCurrentSource(CurrentSource):
    """
    Abstract base class for a current source with a arbitrary cross-section.
    """
    ...
    def plot(self, ax=None, show_coord_sys=False, color="b"):
        """
        Plot the CurrentSource.
        ...
        for points in self.points:
            ax.plot(*points.T, color=f"{color}", linewidth=1)
