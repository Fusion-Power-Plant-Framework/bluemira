...
IN_mappings = {
    ...
    "tk_tf_side": ("dx_tf_side_case_min", "m"),
...
OUT_mappings = {
    ...
    "P_fus": ("p_fusion_total_mw", "MW"),
    "P_fus_DT": ("p_dt_total_mw", "MW"),
    "P_fus_DD": ("p_dd_total_mw", "MW"),
    "H_star": ("hfact", "dimensionless"),
    ...
    "tk_tf_nose": ("dr_tf_nose_case", "m"),
    "tf_wp_width": ("dr_tf_wp_with_insulation", "m"),
    "tf_wp_depth": ("dx_tf_wp_primary_toroidal", "m"),
    "tk_tf_ins": ("dx_tf_wp_insulation", "m"),
    "tk_tf_insgap": ("dx_tf_wp_insertion_gap", "m"),
    "tk_cs": ("dr_cs", "m"),
    "r_cp_top": ("r_cp_top", "m"),
    "r_cs_in": ("dr_bore", "m"),
    "r_tf_in": ("rtfin", "m"),
    ...
    "TF_E_stored": ("e_tf_magnetic_stored_total_gj", "GJ"),
