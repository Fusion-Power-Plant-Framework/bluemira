...
class ProcessInputs:
    ...
    fimpvar: float | None = None
    impvar: int | None = None
    ...
    divleg_profile_inner: float | None = None
    divleg_profile_outer: float | None = None
    divplt: float | None = None
    fdfs: float | None = None
    fdiva: float | None = None
    fgamp: float | None = None
    ...
    ifispact: int | None = None  # listed as an output...
