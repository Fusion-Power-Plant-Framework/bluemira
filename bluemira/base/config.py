...
class Configuration(ConfigurationSchema, ParameterFrame):
    ...
    params = [
        ...
        ['tk_sh_in', 'Inboard shield thickness', 0.0, 'm', "DO NOT USE - PROCESS has VV = VV + shield", 'Input'],
        ['tk_sh_out', 'Outboard shield thickness', 0.0, 'm', "DO NOT USE - PROCESS has VV = VV + shield", 'Input'],
        ['tk_sh_top', 'Upper shield thickness', 0.0, 'm', "DO NOT USE - PROCESS has VV = VV + shield", 'Input'],
        ['tk_sh_bot', 'Lower shield thickness', 0.0, 'm', "DO NOT USE - PROCESS has VV = VV + shield", 'Input'],
        ...
        ['tk_tf_wp', 'TF coil winding pack thickness', 0.5, 'm', 'Excluding insulation', 'Input'],
