...
from bluemira.power_cycle.errors import PowerCycleManagerError, ScenarioBuilderError
...
class ScenarioBuilder:
    ...
    Attributes
    ----------
    scenario: PowerCyclePulse
        (Temporary) Representation of a scenario for Power Cycle
        simulations.
    ...
    @classmethod
    def _validate_subdict(cls, contents_in_key, necessary_dict):
    ...
    def _build_scenario(cls, scenario_config, pulse_library):
        ...
        scenario = pulse_set[-1]
        return scenario, scenario_name, pulse_repetitions
