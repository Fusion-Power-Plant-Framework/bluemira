...
# ruff: noqa: PLR2004, D101, D102, D105, PLR6301

from __future__ import annotations

from typing import TYPE_CHECKING, NDArray, Union
...
class PoloidalCrossSectionLineBase:
    ...
    def shared_viable_config(self, other_line) -> PoloidalCrossSectionLineBase:
    ...
    @property
    def phase_space_repr(self) -> AllowedPointSet:
