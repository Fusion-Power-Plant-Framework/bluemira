...
class AutoPopulatingMaterialsLibrary(MaterialsLibrary):
    ...
    def __getitem__(self, key):
        ...
        if key not in self.keys():
            raise KeyError(
                f"The material {key} hasn't been generated yet. Perhaps it needs to be generated by running self.populate_materials() or self.make_xxxx_mats()?"
            )
    ...
    def make_dcll_mats(self, li_enrich_ao):
        ...
        lined_euro_mat = openmc.Material.mix_materials(
            ...
            materials=[self["eurofer_mat"], al2o3_mat],
        ...
        self["inb_vv_mat"] = openmc.Material.mix_materials(
            ...
            materials=[self["eurofer_mat"], self["water_mat"]],
            fracs=[0.8, 0.2],
            percent_type="vo",
        )
        ...
        self["inb_bz_mat"] = openmc.Material.mix_materials(
            ...
            materials=[lined_euro_mat, PbLi_mat],
        ...
        self["inb_mani_mat"] = openmc.Material.mix_materials(
            name="inb_manifold",
            materials=[self["eurofer_mat"], self["inb_bz_mat"]],
            fracs=[0.573, 0.426],
            percent_type="vo",
        )
        ...
        self["div_fw_mat"] = clone_and_rename_mat(
            self["inb_fw_mat"], 302, "div_first_wall"
        )
    ...
    def make_hcpb_mats(self, li_enrich_ao):
        ...
        self["inb_fw_mat"] = openmc.Material().mix_materials(
            ...
            materials=[self["tungsten_mat"], self["eurofer_mat"], he_cool_mat],
        ...
        self["inb_bz_mat"] = openmc.Material(material_id=102).mix_materials(
            name="inb_breeder_zone",
            materials=[self["eurofer_mat"], Be12Ti_mat, KALOS_ACB_mat, he_cool_mat],
            fracs=[
        ...
        self["inb_mani_mat"] = openmc.Material(material_id=103).mix_materials(
            name="inb_manifold",
            materials=[self["eurofer_mat"], KALOS_ACB_mat, he_cool_mat],
    ...
    def make_wcll_mats(self, li_enrich_ao):
        ...
        self["inb_mani_mat"] = openmc.Material.mix_materials(
            name="inb_manifold",
            materials=[PbLi_mat, self["water_mat"], self["eurofer_mat"]],
...
def _populate_materials(material_lib):
    ...
    """
    material_lib["outb_fw_mat"] = clone_and_rename_mat(
        material_lib["inb_fw_mat"], 201, "outb_first_wall"
    )
    material_lib["outb_bz_mat"] = clone_and_rename_mat(
        material_lib["inb_bz_mat"], 202, "outb_breeder_zone"
    )
    material_lib["outb_mani_mat"] = clone_and_rename_mat(
        material_lib["inb_mani_mat"], 203, "outb_manifold"
    )
    material_lib["outb_vv_mat"] = clone_and_rename_mat(
        material_lib["inb_vv_mat"], 204, "outb_vacuum_vessel"
    )
    material_lib["tf_coil_mat"] = clone_and_rename_mat(
        material_lib["eurofer_mat"], 401, "tf_coil"
    )
    material_lib["container_mat"] = clone_and_rename_mat(
        material_lib["inb_vv_mat"], 501, "container"
    )
    # sf = surface
    material_lib["inb_sf_mat"] = clone_and_rename_mat(
        material_lib["eurofer_mat"], 601, "inb_sf"
    )
    material_lib["outb_sf_mat"] = clone_and_rename_mat(
        material_lib["eurofer_mat"], 602, "outb_sf"
    )
    material_lib["div_sf_mat"] = clone_and_rename_mat(
