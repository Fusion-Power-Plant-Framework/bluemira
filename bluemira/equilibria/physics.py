...
class EqSummary(ParameterFrame):
    ...
    def from_equilibrium(
        ...
        *,
        ...
        return cls(
            ...
            li=Parameter("li", _calc_li_from_Li(li_true, R_0), eq_name, long_name=""),
            li_3=Parameter(
                "li_3",
                calc_li3(eq),
                eq_name,
            ...
            q_95=Parameter("f95", f95.safety_factor(eq), "", eq_name),
            ...
            dz_shaf=Parameter(
                "dx_shaf", dz_shaf, "m", eq_name, long_name="z_shafranov_shift"
            ),
    ...
    def dict_with_units(self, latex=True):  # noqa: FBT002
        ...
        """
        out_dict = {}
        for k, v in self.to_dict(latex_unit=latex).items():
            key_unit = "" if v["unit"] == "" else f"[${v['unit']}$]"
            out_dict[f"{str_to_latex(k)}{key_unit}"] = v["value"]
        return out_dict
