...
class PlasmaCoil:
    ...
    def __init__(
        self, plasma_psi: npt.NDArray, j_tor: Optional[npt.NDArray], grid: Grid
    ):
        self._grid = grid
        self._set_j_tor(j_tor)
        self._set_funcs(plasma_psi)

    def _set_j_tor(self, j_tor: Optional[npt.NDArray]):
        self._j_tor = j_tor
    ...
    def _set_funcs(self, plasma_psi: npt.NDArray):
