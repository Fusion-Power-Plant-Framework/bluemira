...
class BluemiraFace(BluemiraGeo):
    ...
    def faces(self):
        """
        The faces of the face. By definition a list of itself.
        """
        return [self]
    ...
    def shells(self):
        """
        The shells of the face. By definition an empty list.
        """
        return []
    ...
    def solids(self):
        """
        The solids of the face. By definition an empty list.
        """
        return []
