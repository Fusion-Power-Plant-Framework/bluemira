...
def distance_to(wire1: BluemiraWire, wire2: BluemiraWire):
    """Calculate the distance between two BluemiraWires.
    ...
    output:
        ...
        vectors is a list of tuple of shape1's and shape2's points
