...
# Visualisation
# =======================================================================================
class _DisplayCADOptions(display.DisplayCADOptions):
    """
...
def show_cad(
    ...
    options: Optional[Union[_DisplayCADOptions, List[_DisplayCADOptions]]] = None,
):
    """
    ...
    if options is None:
        options = [_DisplayCADOptions()] * len(parts)
