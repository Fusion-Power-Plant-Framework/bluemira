...
from bluemira.optimisation._scipy_opt import SCIPY_ALG_MAPPING, ScipyOptimiser
...
class DebugOptimiser(Optimiser):
    def __init__(
        ...
        *,
        ...
        elif self.algorithm in SCIPY_ALG_MAPPING:
    ...
    def f_objective_wrapper(self, func): ...
    def df_objective_wrapper(self, func): ...
    def eq_constraint_wrapper(self, func): ...
    def ineq_constraint_wrapper(self, func): ...
