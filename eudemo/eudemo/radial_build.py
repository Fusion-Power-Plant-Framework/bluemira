...
template_builder.add_variable("rmajor", 8.8901, lower_bound=0.1, upper_bound=13.0)
...
template_builder.add_variable("fcohbop", 0.93176, lower_bound=0.001, upper_bound=1.0)
template_builder.add_variable("fvsbrnni", 0.39566, lower_bound=0.001, upper_bound=1.0)
template_builder.add_variable("fncycle", 1.0, lower_bound=1.0e-8, upper_bound=1.0)
...
template_builder.adjust_variable("fne0", 0.6, lower_bound=0.001, upper_bound=0.95)
template_builder.adjust_variable("fdene", 1.2, lower_bound=0.001, upper_bound=1.2)
...
template_builder.adjust_variable("fpnetel", 1.0, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("fstrcase", 1.0, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("ftmargtf", 1.0, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("ftmargoh", 1.0, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("ftaulimit", 1.0, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("fjohc", 0.57941, lower_bound=0.01, upper_bound=1.0)
template_builder.adjust_variable("fjohc0", 0.53923, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("foh_stress", 1.0, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("fbetatry", 0.48251, lower_bound=0.01, upper_bound=1.0)
template_builder.adjust_variable("fwalld", 0.131, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("fmaxvvstress", 1.0, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("fpsepbqar", 1.0, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("fvdump", 1.0, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("fstrcond", 0.92007, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("fiooic", 0.63437, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("fjprot", 1.0, lower_bound=0.001, upper_bound=1.0)
template_builder.adjust_variable("fpinj", 1.0, lower_bound=0.001, upper_bound=1.0)
