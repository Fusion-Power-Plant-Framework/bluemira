...
"""
EQDSK file format interface.. NOTE: jsons are better :)
"""
import os
import json
import time
...
class EQDSKInterface:
    ...
    Notes
    -----
    G-EQDSK is from the 1980's I'm guessing this is for retrofitting only
    ...
    def _write_eqdsk(self, file, data):
        ...
        # Definte dummy data for qpsi if it has not been previously defined.
