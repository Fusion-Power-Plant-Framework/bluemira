...
.. figure:: ../images/equilibria/coordinates_grid_domain_crop.png
   :name: fig:domains
...
.. figure:: ../images/equilibria/L_constraints_crop.png
...
.. list-table:: Conversion between real coordinates (x,z) and normalised coordinates (L) for three simple zones. The colourbar shows the sum of the converted coordinates.
    ...
    * - .. figure:: ../images/equilibria/sq.png

    * - .. figure:: ../images/equilibria/circ.png

    * - .. figure:: ../images/equilibria/dia.png
